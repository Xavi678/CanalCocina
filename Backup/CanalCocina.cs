  ...
  public class CanalCocina
  {
    ...
    public Program CreateProgramFromHtmlNode(HtmlNode htmlnode, DateTime basedate)
    {
      ...
      if (htmlNode1 == null || htmlNode2 == null)
        return (Program) null;
      string[] strArray = Regex.Replace(htmlNode1.get_InnerText(), "[^0-9:]", "").Split(':');
      ...
      string input = htmlNode2.get_InnerText();
      string str = htmlNode3.get_InnerText();
      ...
      program.Desc = htmlNode4 == null ? string.Empty : Regex.Replace(htmlNode4.get_InnerHtml(), "\\s+", " ", RegexOptions.Multiline).Trim();
      return program;
    }
  }
}
